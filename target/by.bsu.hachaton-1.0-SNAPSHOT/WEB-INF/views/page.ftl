                        ...
                        <div class="row ">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input id="latitude" class="form-control" type="text" placeholder="Latitude: "
                                           readonly>
                                </div>
                                <div class="form-group">
                                    <label for="longitude">Longtitude</label>
                                    <input id="longitude" class="form-control" type="text" placeholder="Longitude: "
                                           readonly>
                                </div>
                                <button type="button" class="btn btn-primary" id="get-coordinates-button">Get
                                    coordinates
                                </button>
